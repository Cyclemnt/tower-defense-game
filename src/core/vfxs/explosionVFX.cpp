...
namespace tdg::core {
    ...
    void ExplosionVFX::draw(IVideoRenderer& vidRenderer) const {
        // Outer glow
        vidRenderer.drawCircle(m_x1, m_y1, m_radius * 1.6f, m_glow.r, m_glow.g, m_glow.b, m_glow.a);
        // Inner core
        vidRenderer.drawCircle(m_x1, m_y1, m_radius * 0.8f, m_color.r, m_color.g, m_color.b, m_color.a);
    }
